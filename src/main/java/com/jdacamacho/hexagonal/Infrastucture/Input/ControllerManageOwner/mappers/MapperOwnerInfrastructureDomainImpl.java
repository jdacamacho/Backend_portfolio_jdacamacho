...
@Service
public class MapperOwnerInfrastuctureDomainImpl implements MapperOwnerInfrastuctureDomainInt{
    private final ModelMapper mapper;

    public MapperOwnerInfrastuctureDomainImpl(ModelMapper mapper){
        this.mapper = mapper;
    }
